...
val json = """{"wx": {"i": 224, "no": 4, "page": 12, "isSPU": 0, "state": 1},
"app": {"i": 298, "no": 8, "page": 30, "isSPU": 1, "state": "1"},
"web": {"i": 232, "no": 52, "page": 4, "isSPU": -1, "state": 1}}"""
...
fun main(args: Array<String>) {
    ...
    val state: AllRank = mapper.readValue(json)
